...
class AsyncRTSPServer {
 ...
 private:
  ...
  void PrepareRTPBufferForClients(char *RTPBuffer, uint8_t *data, int length, RTPBuffferPreparationResult *bpr,
                                  unsigned const char *quant0tbl, unsigned const char *quant1tbl);
