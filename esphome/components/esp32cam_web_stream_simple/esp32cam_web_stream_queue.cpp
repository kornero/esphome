...
Esp32CamWebStreamSimple *global_esp32cam_web_stream_simple;

void Esp32CamWebStreamSimple::handleRequest(AsyncWebServerRequest *req) {
...
void Esp32CamWebStreamSimple::resetSteps() {
...
float Esp32CamWebStreamSimple::get_setup_priority() const { return setup_priority::AFTER_WIFI; }
...
// Initialise cameras
void Esp32CamWebStreamSimple::initCamera() {
